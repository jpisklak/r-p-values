---
title: "Guide to Computing P-Values Using R"
...
<details>
  <summary>
  Click here for Corresponding Confidence Interval Information
  </summary>
...
- The critical t-score marks the boundary of a tail's critical (rejection) region containing *half* of $\alpha$ (e.g., 2.5% of the distribution for a 95% confidence interval). This is the area displayed in red.
- Together, both tails account for the full $\alpha$ (e.g., 5%).
...
- The critical t-score marks the boundary of the upper tail's critical (rejection) region and encompasses the *entire* significance level $\alpha$ for one-tailed tests. This is the area displayed in red.
...
- The confidence interval is expressed in terms of the alternative hypothesis $H_1: \mu > 1.5$.
- The critical t-score marks the boundary of the lower tail's critical (rejection) region and encompasses the *entire* significance level $\alpha$ for one-tailed tests. This is the area displayed in red.
