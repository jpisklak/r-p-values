...
- The critical t-score marks the boundary of a tail containing *half* of $\alpha$ (e.g., 2.5% of the distribution for a 95% confidence interval).
...
- The critical t-score marks the boundary of the upper tail and encompasses the *entire* significance level $\alpha$ for one-tailed tests.
...
- The confidence interval is expressed in terms of the alternative hypothesis $H_1: \mu > 1.5$.
- The critical t-score marks the boundary of the lower tail and encompasses the *entire* significance level $\alpha$ for one-tailed tests.
